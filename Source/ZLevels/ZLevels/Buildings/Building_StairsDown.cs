...
namespace ZLevels
{
    public class Building_StairsDown : Building_Stairs, IAttackTarget
    {
        ...
        {
            var ZTracker = ZUtils.ZTracker;
            if (ZTracker.stairsDown.TryGetValue(this.Map, out var stairsDown) && stairsDown.Contains(this))
            {
